...
<html lang="en">
  ...
  <body>
    ...
    <nav>
      <ul class="topbar">
        <li>HSBTE</li>
        <li class="hidethis"><a href="index.html">home</a></li>
        <li class="hidethis"><a href="">about</a></li>
        <li class="hidethis"><a href="">contact-us</a></li>
        <li>
        <svg id="openButton" style="fill: white" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 1000 960" width="24">
        ...
        <ul class="sidebar">
        <li>
        <svg id="closeButton" style="fill: white" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
